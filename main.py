...
def download_and_convert(URL, path, progressbar):
    options = {
...
class MainWindow(QMainWindow):
    ...
    def download_video(self):
        ...
        if not self.folder_label.text():
            ...
            progress_thread = threading.Thread(target=download_and_convert, args=(self.line_edit.text(), self.folder_label.text(), self.progressbar))
